...
> Note: The best place to start if you're new to OpenFaaS is the README file in the [openfaas/faas](https://github.com/ryskiwt/faas/blob/master/README.md) repository.
...
`./deploy_stack.armhf.sh` can be run at any time and includes a set of sample functions. You can read more about these in the [TestDrive document](https://github.com/ryskiwt/faas/blob/master/TestDrive.md)
